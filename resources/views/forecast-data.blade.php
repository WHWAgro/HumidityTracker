					...
					<div class="influ-strip">
						<div class="influ-search">
							<form action="{{ url('forecast') }}" method="POST">
								...
								<span style="cursor:pointer" data-href="{{ url('export-csv-forecast') }}" id="export" class="influ-search-btn" onclick ="exportTasks (event.target);"><img src="{{ asset('images/export.png') }}"alt="">Exportar CSV</span>
							</form>
						</div>
					</div>
